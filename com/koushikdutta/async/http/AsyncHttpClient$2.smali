...
# instance fields
.field final synthetic a:Lcom/koushikdutta/async/http/AsyncHttpClientMiddleware$OnResponseCompleteDataOnRequestSentData;
...
.method constructor <init>(Lcom/koushikdutta/async/http/AsyncHttpClient;Lcom/koushikdutta/async/http/AsyncHttpClientMiddleware$OnResponseCompleteDataOnRequestSentData;Lcom/koushikdutta/async/http/AsyncHttpClient$FutureAsyncHttpResponse;Lcom/koushikdutta/async/http/AsyncHttpRequest;Lcom/koushikdutta/async/http/callback/HttpConnectCallback;)V
    ...
    iput-object p2, p0, Lcom/koushikdutta/async/http/AsyncHttpClient$2;->a:Lcom/koushikdutta/async/http/AsyncHttpClientMiddleware$OnResponseCompleteDataOnRequestSentData;
...
.method public run()V
    ...
    .prologue
    .line 242
    iget-object v0, p0, Lcom/koushikdutta/async/http/AsyncHttpClient$2;->a:Lcom/koushikdutta/async/http/AsyncHttpClientMiddleware$OnResponseCompleteDataOnRequestSentData;

    iget-object v0, v0, Lcom/koushikdutta/async/http/AsyncHttpClientMiddleware$OnResponseCompleteDataOnRequestSentData;->b:Lcom/koushikdutta/async/future/Cancellable;
    ...
    invoke-interface {v0}, Lcom/koushikdutta/async/future/Cancellable;->b()Z

    .line 244
    iget-object v0, p0, Lcom/koushikdutta/async/http/AsyncHttpClient$2;->a:Lcom/koushikdutta/async/http/AsyncHttpClientMiddleware$OnResponseCompleteDataOnRequestSentData;

    iget-object v0, v0, Lcom/koushikdutta/async/http/AsyncHttpClientMiddleware$OnResponseCompleteDataOnRequestSentData;->e:Lcom/koushikdutta/async/AsyncSocket;
    ...
    .line 247
    :cond_1a
    iget-object v0, p0, Lcom/koushikdutta/async/http/AsyncHttpClient$2;->e:Lcom/koushikdutta/async/http/AsyncHttpClient;

    iget-object v1, p0, Lcom/koushikdutta/async/http/AsyncHttpClient$2;->b:Lcom/koushikdutta/async/http/AsyncHttpClient$FutureAsyncHttpResponse;
    ...
    iget-object v4, p0, Lcom/koushikdutta/async/http/AsyncHttpClient$2;->c:Lcom/koushikdutta/async/http/AsyncHttpRequest;

    iget-object v5, p0, Lcom/koushikdutta/async/http/AsyncHttpClient$2;->d:Lcom/koushikdutta/async/http/callback/HttpConnectCallback;
