...
.method private b(Lcom/bzbs/event/NetworkStateReceiver$NetworkStateReceiverListener;)V
    ...
    .line 48
    invoke-interface {p1}, Lcom/bzbs/event/NetworkStateReceiver$NetworkStateReceiverListener;->a_()V

    goto :goto_6

    .line 50
    :cond_14
    invoke-interface {p1}, Lcom/bzbs/event/NetworkStateReceiver$NetworkStateReceiverListener;->b_()V
