...
.method private static download(Lcom/facebook/internal/ImageDownloader$RequestKey;Landroid/content/Context;)V
    ...
    sparse-switch v16, :sswitch_data_f6
    ...
    :try_end_5e
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5e} :catch_b6
    .catch Ljava/net/URISyntaxException; {:try_start_5 .. :try_end_5e} :catch_d3
    .catchall {:try_start_5 .. :try_end_5e} :catchall_ed
    ...
    :try_end_b5
    .catch Ljava/io/IOException; {:try_start_71 .. :try_end_b5} :catch_b6
    .catch Ljava/net/URISyntaxException; {:try_start_71 .. :try_end_b5} :catch_d3
    .catchall {:try_start_71 .. :try_end_b5} :catchall_ed
    ...
    :try_end_d1
    .catch Ljava/io/IOException; {:try_start_bf .. :try_end_d1} :catch_b6
    .catch Ljava/net/URISyntaxException; {:try_start_bf .. :try_end_d1} :catch_d3
    ...
    :try_end_eb
    .catch Ljava/io/IOException; {:try_start_dc .. :try_end_eb} :catch_b6
    .catch Ljava/net/URISyntaxException; {:try_start_dc .. :try_end_eb} :catch_d3
    .catchall {:try_start_dc .. :try_end_eb} :catchall_ed
