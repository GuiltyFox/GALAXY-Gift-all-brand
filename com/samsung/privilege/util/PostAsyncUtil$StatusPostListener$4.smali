.class Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;->onIOException(Ljava/io/IOException;Ljava/lang/Object;)V
.end annotation
...
# direct methods
.method constructor <init>(Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;Ljava/io/IOException;)V
    .registers 3

    .prologue
    .line 1
    iput-object p1, p0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;->this$1:Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;

    iput-object p2, p0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;->val$e:Ljava/io/IOException;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;->val$e:Ljava/io/IOException;
    ...
    .line 1504
    :try_start_8
    iget-object v0, p0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;->this$1:Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;

    iget-object v0, v0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;->StrPageHeader:Ljava/lang/String;

    iget-object v1, p0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;->this$1:Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;

    iget-object v1, v1, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;->StrMessage:Ljava/lang/String;

    iget-object v2, p0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;->this$1:Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;

    iget v2, v2, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;->IntPAGE_MODE:I

    iget-object v3, p0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;->this$1:Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;

    iget v3, v3, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;->IntNotification_posting_number:I

    iget-object v4, p0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;->this$1:Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;
    ...
    iget-object v5, p0, Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener$4;->this$1:Lcom/samsung/privilege/util/PostAsyncUtil$StatusPostListener;
