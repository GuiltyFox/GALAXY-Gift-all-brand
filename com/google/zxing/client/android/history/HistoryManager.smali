...
.method static saveHistory(Ljava/lang/String;)Landroid/net/Uri;
    ...
    :try_end_63
    .catch Ljava/io/IOException; {:try_start_53 .. :try_end_63} :catch_85
    .catchall {:try_start_53 .. :try_end_63} :catchall_ac
    ...
    :try_end_7c
    .catch Ljava/io/IOException; {:try_start_63 .. :try_end_7c} :catch_b8
    ...
    invoke-static {v7, v8}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_a4
    .catchall {:try_start_86 .. :try_end_a4} :catchall_ac
...
.method public addHistoryItemDetails(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_end_56
    .catchall {:try_start_b .. :try_end_56} :catchall_7e
    ...
    :try_end_7c
    .catchall {:try_start_5a .. :try_end_7c} :catchall_7e
...
.method buildHistory()Ljava/lang/CharSequence;
    ...
    :try_end_25
    .catchall {:try_start_9 .. :try_end_25} :catchall_c9
    ...
    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    :try_end_c7
    .catchall {:try_start_2e .. :try_end_c7} :catchall_c9
...
.method public buildHistoryItems()Ljava/util/List;
    ...
    invoke-interface {v8}, Landroid/database/Cursor;->moveToNext()Z
    :try_end_23
    .catchall {:try_start_e .. :try_end_23} :catchall_57
...
.method public deleteHistoryItem(I)V
    ...
    :try_end_3a
    .catchall {:try_start_9 .. :try_end_3a} :catchall_3e
...
.method public trimHistory()V
    ...
    invoke-interface {v8}, Landroid/database/Cursor;->moveToNext()Z
    :try_end_23
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_9 .. :try_end_23} :catch_59
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_58
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_2b .. :try_end_58} :catch_59
    .catchall {:try_start_2b .. :try_end_58} :catchall_63
