...
.method static applyCustomTransformations(Ljava/util/List;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    :try_end_11
    .catch Ljava/lang/RuntimeException; {:try_start_e .. :try_end_11} :catch_58
    ...
    const-string/jumbo v9, "Transformation "
    ...
    const-string/jumbo v9, " returned null after "
    ...
    const-string/jumbo v9, " previous transformation(s).\n\nTransformation list:\n"
...
.method static decodeStream(Ljava/io/InputStream;Lcom/squareup/picasso/Request;)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v9, "Failed to decode stream."
...
.method attach(Lcom/squareup/picasso/Action;)V
    ...
    const-string/jumbo v6, "to empty hunter"
...
.method hunt()Landroid/graphics/Bitmap;
    ...
    :try_end_69
    .catchall {:try_start_64 .. :try_end_69} :catchall_f8
    ...
    const-string/jumbo v8, "from custom transformations"
    ...
    monitor-exit v5
    :try_end_ea
    .catchall {:try_start_98 .. :try_end_ea} :catchall_fd
