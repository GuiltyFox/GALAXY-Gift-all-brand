...
.method private logBatch(Ljava/util/List;)V
    ...
    :cond_41
    const-string/jumbo v4, "Dispatcher"
...
.method performCancel(Lcom/squareup/picasso/Action;)V
    ...
    const-string/jumbo v6, "because paused request got canceled"
    ...
    const-string/jumbo v6, "from replaying"
...
.method performPauseTag(Ljava/lang/Object;)V
    ...
    const-string/jumbo v12, "because tag \'"
    ...
    const-string/jumbo v12, "\' was paused"
    ...
    const-string/jumbo v11, "all actions paused"
...
.method performSubmit(Lcom/squareup/picasso/Action;Z)V
    ...
    const-string/jumbo v5, "because tag \'"
    ...
    const-string/jumbo v5, "\' is paused"
    ...
    const-string/jumbo v4, "because shut down"
    ...
    const-string/jumbo v2, "enqueued"
