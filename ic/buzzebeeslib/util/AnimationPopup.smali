...
.method public static playPopupMarketBzbs(ILandroid/app/Activity;Landroid/widget/RelativeLayout;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/LinearLayout;Landroid/widget/RelativeLayout;Landroid/widget/RelativeLayout;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/widget/TextView;)V
    ...
    invoke-static {v4}, Lic/buzzebeeslib/util/LanguageSetting;->SetLanguage(Landroid/content/Context;)V

    .line 108
    sget v4, Lic/buzzebeeslib/R$string;->intro_back:I
    ...
    .line 109
    sget v4, Lic/buzzebeeslib/R$string;->intro_next:I
    ...
    sput v4, Lic/buzzebeeslib/util/AnimationPopup;->gCurrentPopupWelcome:I
    ...
    .line 128
    new-instance v4, Lic/buzzebeeslib/util/AnimationPopup$1;

    invoke-direct {v4}, Lic/buzzebeeslib/util/AnimationPopup$1;-><init>()V
    ...
    .line 136
    new-instance v4, Lic/buzzebeeslib/util/AnimationPopup$2;
    ...
    invoke-direct/range {v4 .. v13}, Lic/buzzebeeslib/util/AnimationPopup$2;-><init>(Landroid/widget/ImageView;Landroid/widget/ImageView;IZLandroid/widget/RelativeLayout;Landroid/app/Activity;Landroid/widget/TextView;Landroid/widget/RelativeLayout;Landroid/widget/LinearLayout;)V
    ...
    .line 236
    new-instance v9, Lic/buzzebeeslib/util/AnimationPopup$3;
    ...
    invoke-direct/range {v9 .. v18}, Lic/buzzebeeslib/util/AnimationPopup$3;-><init>(Landroid/app/Activity;Landroid/widget/ImageView;Landroid/widget/ImageView;IZLandroid/widget/RelativeLayout;Landroid/widget/TextView;Landroid/widget/RelativeLayout;Landroid/widget/LinearLayout;)V
    ...
    invoke-static {v0, v4, v8}, Lic/buzzebeeslib/util/AnimationPopup;->getImagePopup(IIZ)I
    ...
    .line 353
    invoke-static/range {v19 .. v20}, Lic/buzzebeeslib/util/AnimationPopup;->smallToBig1Animation(FF)Landroid/view/animation/Animation;
    ...
    .line 359
    new-instance v4, Lic/buzzebeeslib/util/AnimationPopup$4;
    ...
    invoke-direct {v4, v0, v1, v2}, Lic/buzzebeeslib/util/AnimationPopup$4;-><init>(Landroid/app/Activity;Landroid/widget/LinearLayout;Landroid/widget/ImageView;)V
