.class Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener;->onPostSucceed(Ljava/lang/String;ILjava/util/ArrayList;)V
.end annotation
...
.method constructor <init>(Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener;ILjava/util/ArrayList;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->this$1:Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener;

    iput p2, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->val$points:I

    iput-object p3, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->val$badgeAlerts:Ljava/util/ArrayList;
...
.method public run()V
    ...
    .line 466
    :try_start_0
    iget v1, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->val$points:I
    ...
    iget v3, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->val$points:I
    ...
    iget v2, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->val$points:I
    ...
    iget-object v2, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->this$1:Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener;
    ...
    iget-object v3, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->this$1:Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener;
    ...
    :cond_40
    iget-object v1, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->val$badgeAlerts:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->val$badgeAlerts:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->val$badgeAlerts:Ljava/util/ArrayList;

    invoke-interface {v1, v2}, Ljava/util/Queue;->addAll(Ljava/util/Collection;)Z

    .line 476
    :cond_69
    iget-object v1, p0, Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener$2;->this$1:Lic/buzzebeeslib/fragment/PlaceMainFragment$FBPostListener;
