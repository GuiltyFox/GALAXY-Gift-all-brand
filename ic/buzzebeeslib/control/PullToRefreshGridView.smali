.class public Lic/buzzebeeslib/control/PullToRefreshGridView;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lic/buzzebeeslib/control/PullToRefreshGridView$InternalGridView;,
        Lic/buzzebeeslib/control/PullToRefreshGridView$InternalGridViewSDK9;
    }
.end annotation
...
.method protected bridge synthetic createRefreshableView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .prologue
    .line 1
    invoke-virtual {p0, p1, p2}, Lic/buzzebeeslib/control/PullToRefreshGridView;->createRefreshableView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/widget/GridView;
...
.method protected final createRefreshableView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/widget/GridView;
    ...
    .line 58
    new-instance v0, Lic/buzzebeeslib/control/PullToRefreshGridView$InternalGridViewSDK9;

    invoke-direct {v0, p0, p1, p2}, Lic/buzzebeeslib/control/PullToRefreshGridView$InternalGridViewSDK9;-><init>(Lic/buzzebeeslib/control/PullToRefreshGridView;Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    :cond_11
    new-instance v0, Lic/buzzebeeslib/control/PullToRefreshGridView$InternalGridView;

    invoke-direct {v0, p0, p1, p2}, Lic/buzzebeeslib/control/PullToRefreshGridView$InternalGridView;-><init>(Lic/buzzebeeslib/control/PullToRefreshGridView;Landroid/content/Context;Landroid/util/AttributeSet;)V
