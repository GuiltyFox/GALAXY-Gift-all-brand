...
.method static a(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/io/File;Z)Ljava/util/List;
    ...
    :try_end_44
    .catch Ljava/io/IOException; {:try_start_41 .. :try_end_44} :catch_6b
...
.method private static a(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    throw v0
    :try_end_13a
    .catchall {:try_start_27 .. :try_end_13a} :catchall_13a
    ...
    :try_end_13e
    .catch Ljava/io/IOException; {:try_start_13b .. :try_end_13e} :catch_173
    ...
    invoke-virtual {v8, v0}, Ljava/util/zip/ZipFile;->getEntry(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    :try_end_15f
    .catchall {:try_start_141 .. :try_end_15f} :catchall_13a
...
.method private static a(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_end_3c
    .catchall {:try_start_2d .. :try_end_3c} :catchall_c0
    ...
    :try_end_65
    .catchall {:try_start_3c .. :try_end_65} :catchall_c8
    ...
    throw v0
    :try_end_c0
    .catchall {:try_start_65 .. :try_end_c0} :catchall_c0
    ...
    throw v0
    :try_end_cd
    .catchall {:try_start_c9 .. :try_end_cd} :catchall_c0
...
.method static a(Ljava/io/File;)Z
    ...
    :try_end_5
    .catch Ljava/util/zip/ZipException; {:try_start_0 .. :try_end_5} :catch_2b
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_5} :catch_52
    ...
    .catch Ljava/util/zip/ZipException; {:try_start_5 .. :try_end_8} :catch_2b
    ...
    invoke-static {v0, v1}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_29
    .catch Ljava/util/zip/ZipException; {:try_start_b .. :try_end_29} :catch_2b
    .catch Ljava/io/IOException; {:try_start_b .. :try_end_29} :catch_52
