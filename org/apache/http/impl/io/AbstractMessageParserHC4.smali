...
.method public constructor <init>(Lorg/apache/http/io/SessionInputBuffer;Lorg/apache/http/message/LineParser;Lorg/apache/http/config/MessageConstraints;)V
    ...
    .prologue
    .line 112
    .local p0, "this":Lorg/apache/http/impl/io/AbstractMessageParserHC4;, "Lorg/apache/http/impl/io/AbstractMessageParserHC4<TT;>;"
...
.method public parse()Lorg/apache/http/HttpMessage;
    ...
    .line 256
    .local p0, "this":Lorg/apache/http/impl/io/AbstractMessageParserHC4;, "Lorg/apache/http/impl/io/AbstractMessageParserHC4<TT;>;"
    iget v3, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->state:I
    ...
    :pswitch_e
    :try_start_e
    iget-object v4, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->sessionBuffer:Lorg/apache/http/io/SessionInputBuffer;

    invoke-virtual {p0, v4}, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->parseHead(Lorg/apache/http/io/SessionInputBuffer;)Lorg/apache/http/HttpMessage;

    move-result-object v4

    iput-object v4, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->message:Lorg/apache/http/HttpMessage;
    :try_end_16
    ...
    iput v4, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->state:I

    .line 267
    :pswitch_19
    iget-object v4, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->sessionBuffer:Lorg/apache/http/io/SessionInputBuffer;

    iget-object v5, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->messageConstraints:Lorg/apache/http/config/MessageConstraints;

    invoke-virtual {v5}, Lorg/apache/http/config/MessageConstraints;->getMaxHeaderCount()I

    move-result v5

    iget-object v6, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->messageConstraints:Lorg/apache/http/config/MessageConstraints;

    invoke-virtual {v6}, Lorg/apache/http/config/MessageConstraints;->getMaxLineLength()I

    move-result v6

    iget-object v7, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->lineParser:Lorg/apache/http/message/LineParser;

    iget-object v8, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->headerLines:Ljava/util/List;

    invoke-static {v4, v5, v6, v7, v8}, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->parseHeaders(Lorg/apache/http/io/SessionInputBuffer;IILorg/apache/http/message/LineParser;Ljava/util/List;)[Lorg/apache/http/Header;

    move-result-object v0

    .line 273
    .local v0, "headers":[Lorg/apache/http/Header;
    iget-object v4, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->message:Lorg/apache/http/HttpMessage;

    invoke-interface {v4, v0}, Lorg/apache/http/HttpMessage;->setHeaders([Lorg/apache/http/Header;)V

    .line 274
    iget-object v2, p0, Lorg/apache/http/impl/io/AbstractMessageParserHC4;->message:Lorg/apache/http/HttpMessage;
