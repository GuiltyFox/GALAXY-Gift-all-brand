...
.field private final d:Lrx/plugins/RxJavaSchedulersHook;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrx/internal/schedulers/NewThreadWorker;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sput-object v0, Lrx/internal/schedulers/NewThreadWorker;->g:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sput v0, Lrx/internal/schedulers/NewThreadWorker;->b:I
    ...
    .line 57
    invoke-static {}, Lrx/internal/util/PlatformDependent;->b()I
    ...
    sput-object v0, Lrx/internal/schedulers/NewThreadWorker;->i:Ljava/lang/Object;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    .line 206
    invoke-static {v1}, Lrx/internal/schedulers/NewThreadWorker;->b(Ljava/util/concurrent/ScheduledExecutorService;)Z
    ...
    invoke-static {v0}, Lrx/internal/schedulers/NewThreadWorker;->a(Ljava/util/concurrent/ScheduledThreadPoolExecutor;)V
    ...
    iput-object v0, p0, Lrx/internal/schedulers/NewThreadWorker;->d:Lrx/plugins/RxJavaSchedulersHook;

    .line 211
    iput-object v1, p0, Lrx/internal/schedulers/NewThreadWorker;->c:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static a(Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    .prologue
    .line 98
    sget-object v0, Lrx/internal/schedulers/NewThreadWorker;->f:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static a(Ljava/util/concurrent/ScheduledThreadPoolExecutor;)V
    ...
    .line 71
    :goto_0
    sget-object v0, Lrx/internal/schedulers/NewThreadWorker;->g:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 76
    sget-object v1, Lrx/internal/schedulers/NewThreadWorker;->g:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget v2, Lrx/internal/schedulers/NewThreadWorker;->b:I

    int-to-long v2, v2

    sget v4, Lrx/internal/schedulers/NewThreadWorker;->b:I
...
.method public static b(Ljava/util/concurrent/ScheduledExecutorService;)Z
    ...
    .line 145
    sget-object v0, Lrx/internal/schedulers/NewThreadWorker;->h:Ljava/lang/Object;

    .line 147
    sget-object v1, Lrx/internal/schedulers/NewThreadWorker;->i:Ljava/lang/Object;
    ...
    .line 152
    invoke-static {p0}, Lrx/internal/schedulers/NewThreadWorker;->c(Ljava/util/concurrent/ScheduledExecutorService;)Ljava/lang/reflect/Method;
    ...
    :goto_1b
    sput-object v0, Lrx/internal/schedulers/NewThreadWorker;->h:Ljava/lang/Object;
    ...
    .line 154
    :cond_2f
    sget-object v0, Lrx/internal/schedulers/NewThreadWorker;->i:Ljava/lang/Object;
...
.method public a(Lrx/functions/Action0;JLjava/util/concurrent/TimeUnit;)Lrx/Subscription;
    ...
    :cond_9
    invoke-virtual {p0, p1, p2, p3, p4}, Lrx/internal/schedulers/NewThreadWorker;->b(Lrx/functions/Action0;JLjava/util/concurrent/TimeUnit;)Lrx/internal/schedulers/ScheduledAction;
...
.method public a(Lrx/functions/Action0;JLjava/util/concurrent/TimeUnit;Lrx/subscriptions/CompositeSubscription;)Lrx/internal/schedulers/ScheduledAction;
    .registers 10

    .prologue
    .line 248
    iget-object v0, p0, Lrx/internal/schedulers/NewThreadWorker;->d:Lrx/plugins/RxJavaSchedulersHook;

    invoke-virtual {v0, p1}, Lrx/plugins/RxJavaSchedulersHook;->a(Lrx/functions/Action0;)Lrx/functions/Action0;
    ...
    .line 250
    invoke-virtual {p5, v1}, Lrx/subscriptions/CompositeSubscription;->a(Lrx/Subscription;)V
    ...
    .line 254
    iget-object v0, p0, Lrx/internal/schedulers/NewThreadWorker;->c:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public b(Lrx/functions/Action0;JLjava/util/concurrent/TimeUnit;)Lrx/internal/schedulers/ScheduledAction;
    .registers 9
