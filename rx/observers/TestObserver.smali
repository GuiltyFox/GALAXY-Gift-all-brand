...
.method public assertReceivedOnNext(Ljava/util/List;)V
    ...
    const-string/jumbo v5, "Number of items does not match. Provided: "
    ...
    const-string/jumbo v5, "Value at index: "
    ...
    const-string/jumbo v5, " expected to be [null] but was: ["
    ...
    const-string/jumbo v5, " expected to be ["
...
.method public assertTerminalEvent()V
    ...
    const-string/jumbo v2, "Too many onError events: "
    ...
    const-string/jumbo v2, "Too many onCompleted events: "
    ...
    const-string/jumbo v1, "Received both an onError and onCompleted. Should be one or the other."
    ...
    const-string/jumbo v1, "No terminal events received."
