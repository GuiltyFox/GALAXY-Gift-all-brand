...
.method protected getHorizontalScrollFactor()F
    ...
    const-string/jumbo v3, "Expected theme to define hlv_listPreferredItemWidth."
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v11, v8, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->checkState:Landroid/support/v4/util/SparseArrayCompat;
    :try_end_96
    .catch Ljava/lang/NoSuchMethodError; {:try_start_8e .. :try_end_96} :catch_ef
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    packed-switch v25, :pswitch_data_75e
    ...
    packed-switch v25, :pswitch_data_770
    ...
    packed-switch v25, :pswitch_data_776
    ...
    packed-switch v25, :pswitch_data_786
    ...
    packed-switch v25, :pswitch_data_796
...
.method public reclaimViews(Ljava/util/List;)V
    ...
    # getter for: Lit/sephiroth/android/library/widget/AbsHListView$RecycleBin;->mRecyclerListener:Lit/sephiroth/android/library/widget/AbsHListView$RecyclerListener;
    invoke-static {v5}, Lit/sephiroth/android/library/widget/AbsHListView$RecycleBin;->access$2200(Lit/sephiroth/android/library/widget/AbsHListView$RecycleBin;)Lit/sephiroth/android/library/widget/AbsHListView$RecyclerListener;

    move-result-object v3

    .line 5312
    .local v3, "listener":Lit/sephiroth/android/library/widget/AbsHListView$RecyclerListener;
    const/4 v2, 0x0
    ...
    iget v6, v4, Lit/sephiroth/android/library/widget/AbsHListView$LayoutParams;->viewType:I

    invoke-virtual {v5, v6}, Lit/sephiroth/android/library/widget/AbsHListView$RecycleBin;->shouldRecycleViewType(I)Z
    ...
    .line 5325
    invoke-interface {v3, v0}, Lit/sephiroth/android/library/widget/AbsHListView$RecyclerListener;->onMovedToScrapHeap(Landroid/view/View;)V
    ...
    invoke-virtual {v5, p1}, Lit/sephiroth/android/library/widget/AbsHListView$RecycleBin;->reclaimScrapViews(Ljava/util/List;)V
...
.method protected smoothScrollByOffset(I)V
    ...
    invoke-virtual {p0, v7}, Lit/sephiroth/android/library/widget/AbsHListView;->smoothScrollToPosition(I)V
...
.method trackMotionScroll(II)Z
    ...
    if-lt v0, v3, :cond_1a7

    move/from16 v0, v24

    if-ge v0, v3, :cond_1ac
